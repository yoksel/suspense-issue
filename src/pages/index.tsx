...
export default function Home() {
      ...
      >
        <main className={styles.main}>
          <div>
            ...
            <p>It works this way in Chrome while everything is fine in Safari and Firefox.</p>
            ...
            <section>
              ...
              <p>This demo contains <b>2</b> paragraphs of text. It makes <code>Suspense</code> component show fallback instead of children during server side rendering 👇</p>

              <h3>Result</h3>

              <Suspense fallback={<>👋 I am a fallback in <code>Suspense</code></>}>
  ...
  <p>{loremIpsum}</p>
            ...
            <section>
              ...
              <p>This demo contains only <b>1</b> paragraph of text so <code>Suspense</code> renders children 👇</p>
